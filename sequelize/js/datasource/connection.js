...
var ConnectionToDb = /** @class */ (function () {
    function ConnectionToDb() {
    }
    ConnectionToDb.getInstance = function () {
    ...
    ConnectionToDb.prototype.connect = function () {
        this.sequelize = new Sequelize("sequelize_db", "postgres", "admin", {
            host: "localhost",
            dialect: "postgres",
        });
    };
    ConnectionToDb.prototype.checkConnectiion = function () {
    ...
    ConnectionToDb.prototype.closeConnection = function () {
        this.sequelize.close().then(function (res) {
