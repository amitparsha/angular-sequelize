...
var CustomerCrud = /** @class */ (function () {
    function CustomerCrud() {
    }
    CustomerCrud.getInstance = function () {
        if (!this.instance) {
            this.instance = new CustomerCrud();
        }
        return this.instance;
    };
    CustomerCrud.prototype.getCustomers = function () {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        customers = [];
                        return [4 /*yield*/, customerModel.findAll().then(function (result) {
...
exports.CustomerCrud = CustomerCrud;
